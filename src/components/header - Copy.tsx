...
const navItems = [
  ...
  {
    // Services item now defaults to Individual when clicked.
    title: "Services",
        ...
        <nav className="hidden md:flex items-center space-x-1 lg:space-x-2">
          {navItems.map((item) =>
            item.subItems ? (
              ...
              >
                {item.title === "Services" ? (
                  // Render "Services" with a clickable link and separate dropdown arrow.
                  ...
                  // For other items with subItems, use a button.
                  <button
                    className={cn(
