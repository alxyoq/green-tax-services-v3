      ...
      <div className="container">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <p className="text-muted-foreground">
            Our tax preparation process is designed to be simple, effective, and transparent. We've developed a step-by-step approach to ensure your tax filing experience is smooth and efficient.
          </p>
          <p className="text-muted-foreground mt-4">
            <span className="bg-primary/10 text-primary px-2 py-1 rounded font-medium">
              Starting in 2024
            </span>
            , we will be utilizing our client portal to keep clients updated on each step in the process, so you can always log in to your portal account and see what stage your tax return is in.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative mb-16">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-2xl font-heading font-semibold ml-4 text-primary">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Use our secure online portal at{" "}
                          <a
                            href="https://greentaxinc.com/"
                            target="_blank"
                          ...
                          . Click on Client Portal to sign up or log in.
                        </p>
                      </div>
                    </div>
                  </div>
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          ...
                          <span className="text-xs">
                            (We check our PO Box weekly throughout the year)
                          </span>
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          ...
                          <span className="text-xs">
                            (Many banks still have faxes you can use to send us data)
                          </span>
                        </p>
                      </div>
                    </div>
          ...
          {/* Step 2 - Signal the Green Light (Updated Version) */}
          <div className="relative mb-16">
            <div className="flex items-center mb-6">
              <div className="w-12 h-12 bg-primary rounded-full flex items-center justify-center text-white font-bold text-xl">
                2
            ...
            <Card className="ml-6 border-l-4 border-l-primary">
              <CardContent className="pt-6">
                ...
                <div className="bg-neutral-50 p-4 rounded-lg flex items-start">
                  <div className="bg-primary/10 p-2 rounded-full mr-3">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:flex-1 mb-6 md:mb-0 md:mr-10">
              <h2 className="text-2xl font-heading font-semibold mb-4 text-primary">
                2024 Process Enhancement
              </h2>
              <p className="text-muted-foreground mb-4">
                Starting in 2024, we will be utilizing our client portal to keep clients updated on each step in the process.
